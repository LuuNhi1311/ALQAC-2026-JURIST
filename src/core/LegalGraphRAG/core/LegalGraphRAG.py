...
from ALQAC.src.core.LegalGraphRAG.core.models import BaseModel
from ALQAC.src.core.LegalGraphRAG.core.utils.util import analyze_case
from ALQAC.src.core.LegalGraphRAG.core.graph_construct.graph_db import GraphDBManager
...
class LegalGraphRAG:
    ...
    def _init_model(self) -> BaseModel:
        """Initialize model"""
        from ALQAC.src.core.LegalGraphRAG.core.models import (
    ...
    def build_graph(self, force_rebuild: bool = False):
        ...
        """
        from ALQAC.src.core.LegalGraphRAG.core.graph_construct.feature_graph import construct_feature_graph
